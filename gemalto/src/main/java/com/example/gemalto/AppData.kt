...
internal object AppData {
     ...
     */
    fun getRsaKeyId(): String = "acba-public-key"

    /**
     * Replace this URL with your EPS URL.
     */
    fun getEpsUrl(): String = if (BuildConfig.DEBUG) "https://online1-test.acba.am/api/mobiletoken/provisioning" else "https://www.acbadigital.am/api/mobiletoken/provisioning"
     ...
     * file, this guideline is skipped.
     */
    fun getRsaKeyExponent(): ByteArray = byteArrayOf(0x01.toByte(), 0x00.toByte(), 0x01.toByte())
     ...
     */
    fun getCustomFingerprintData(): ByteArray = "am.acba.acbamobile.application.ACBAApplication".toByteArray()
}